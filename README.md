...
4. Visual perturbation for text-based person search, AAAI 2025, Pengcheng Zhang et al., [[PDF](https://ojs.aaai.org/index.php/AAAI/article/view/33091)]
5. DM-Adapter: Domain-Aware Mixture-of-Adapters for Text-Based Person Retrieval, AAAI 2025, Yating Liu et al., [[PDF](https://ojs.aaai.org/index.php/AAAI/article/view/32608)]
6. Test-Time Adaptation for Text-Based Person Search, AAAI 2025, Kai Niu et al., [[PDF](https://dl.acm.org/doi/abs/10.1145/3746027.3754946)]
7. Graph-based cross-domain knowledge distillation for cross-dataset text-to-image person retrieval, AAAI 2025, Bingjun Luo et al., [[PDF](https://ojs.aaai.org/index.php/AAAI/article/view/32037)]
8. Dual Uncertainty-Guided Feature Alignment Learning for Text-Based Person Retrieval, ACM MM 2025, Yufei Zheng et al., [[PDF](https://dl.acm.org/doi/pdf/10.1145/3746027.3755063)]
9. Learning Hierarchical Cross-modal Association with Intra-modal Context for Text-Image Person Retrieval, ACM MM 2025, Yifei Deng et al., [[PDF](https://dl.acm.org/doi/epdf/10.1145/3746027.3754721)]
10. GPT-ReID: Learning Fine-grained Representation with GPT for Text-based Person Retrieval, ACM MM 2025, Xudong Wang et al., [[PDF](https://dl.acm.org/doi/pdf/10.1145/3746027.3755123)]
11. Chat-Driven Text Generation and Interaction for Person Retrieval, EMNLP 2025, Zequn Xie et al., [[PDF](https://aclanthology.org/2025.emnlp-main.266/)]
